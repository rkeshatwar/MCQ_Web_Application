...
<body>
	<nav style="width: 100%; display: flex; justify-content: center; flex-wrap: wrap;">
    ...
    <div class="container">
		<div class="registrtioncontainer">
			<div class="form">
				<form class="signup-form" action="registerationLink" method="post">
					<i class="fa-solid fa-user-plus"></i>				
					<input class="user-input" type="text" name="userName" placeholder="Enter Full Name" required="required">
					<input class="user-input" type="text" name="userEmailId" placeholder="Enter Email ID" required="required">
					<input class="user-input" type="text" name="contactNumber" placeholder="Enter Contact Number" required="required">
					<input type="radio" name="gender" value="male" required>MALE 
					<input type="radio" name="gender" value="female">FEMALE				
					<br><br> 		
					<input class="user-input" type="password"  id="password" name="password1" placeholder="Enter Password" required="required">
					<input class="user-input" type="password"  id="confirmPassword" name="password2" placeholder="Confirm Password" required="required">
					<input class="btn" type="submit" value="Register" >
					<div class="option-02">
						<p>Already Registered? <a href="Login.jsp">Sign Up</a></p>
					</div>
				</form>
			</div>
		</div>
