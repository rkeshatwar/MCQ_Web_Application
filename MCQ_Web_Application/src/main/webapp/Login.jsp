...
<body>
	...
	if(msg!=null) {
		if(msg.equals("Registration Successful")){%>
			<p align="center" style="padding-top: 10px; color: green "><%=msg %></p>
		<%}else {%>
			<p align="center" style="padding-top: 10px; color: red "><%=msg %></p>
		<%}
	}%>		
	<div class="container">	
		<div class="logincontainer">	
			<div class="form">
				<form class="login-form" action="loginLink" method="post">
					...
					<input class="user-input" type="text" name="userData" placeholder="Email or Contact_No" required="required">
					<input class="user-input" type="password" name="userPassword" placeholder="Password" required="required">
					<div class="option-01">
						<a href="#">Forgot Password?</a>
					</div>
					<input class="btn" type="submit" value="Login" >
					<div class="option-02">
						<p>Not Registered? <a href="Registration.jsp">Create an Account</a></p>
					</div>
				</form>
			</div>
		</div>
